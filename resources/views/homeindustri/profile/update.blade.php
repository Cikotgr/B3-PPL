...
@section('content')
    <div class="container">
        <form action="{{ route('homeindustri.profile.update', $item->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="d-flex">
                ...
                <a href="{{ route('homeindustri.profile.index') }}" type="button" class="btn btn-danger">Batal</a>
            </div>
